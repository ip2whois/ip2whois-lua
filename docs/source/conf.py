...
myst_html_meta = {
    "description": "IP2WHOIS Lua library enables user to easily implement the checking of WHOIS information for a particular domain into their solution using the API from www.ip2whois.com.",
    "keywords": "IP2WHOIS, Lua, WHOIS, domain",
...
html_title = "IP2WHOIS Lua SDK"

# html_baseurl = "https://ip2whois-lua.readthedocs.io/en/latest/"